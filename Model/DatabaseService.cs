...
namespace Space
{
    ...
    public static class DatabaseService
    {
        ...
        public static async Task AddProjectAsync(string name, string desc, DateTime start, DateTime deadline, string status, int? managerId = null)
        {
            using (var conn = GetConnection())
            {
                await conn.OpenAsync();
        ...
        public static async Task<List<DropdownItem>> GetTasksDropdownAsync()
        {
            ...
            {
                await conn.OpenAsync();
                // Return ALL tasks so closed/advanced tasks still appear in report form
                using (var cmd = new NpgsqlCommand(
        ...
        public static async Task UpdateProjectAsync(int id, string name, DateTime start, DateTime deadline, string status, int? managerId = null)
        {
            using (var conn = GetConnection())
            {
                await conn.OpenAsync();
